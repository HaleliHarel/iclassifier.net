  ...
  function() {
    ...
    Builder2.prototype.trackConversion = function(amount, contentId, variationId, customProperties, context) {
      ...
      this.track("conversion", {
        amount,
        variationId: useVariationId && useContentId && useVariationId !== useContentId ? useVariationId : void 0,
        meta,
    ...
    Object.defineProperty(Builder2.prototype, "contentId", {
      get: function() {
        return this.contentId$.value;
      },
      set: function(id2) {
        this.contentId$.next(id2);
      },
      enumerable: false,
      configurable: true
    });
    ...
    Builder2.prototype.flushGetContentQueue = function(usePastQueue, useQueue) {
      ...
      for (var _i2 = 0, queue_2 = queue; _i2 < queue_2.length; _i2++) {
        ...
        if (this.apiEndpoint === "query") {
          if ("enrich" in options && options.enrich !== void 0) {
    ...
    Builder2.prototype.flattenEnrichOptions = function(obj, prefix, result) {
      for (var _i2 = 0, _a3 = Object.entries(obj); _i2 < _a3.length; _i2++) {
...
function deepCloneWithConditions(e) {
  ...
  var t = {};
  for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && ("meta" === n ? t.meta = e.meta : t[n] = deepCloneWithConditions(e[n]));
  return t;
}
...
var BuilderBlock$1 = function(_super) {
  ...
  return __extends(BuilderBlock, _super), Object.defineProperty(BuilderBlock.prototype, "store", { get: function() {
    ...
    var x = voidElements.has(p), S = h && (h.fragment || h.noWrap), k = (null === (a = v.attr) || void 0 === a ? void 0 : a.style) || ("string" == typeof v.style ? v.style : "") || "";
    if ("string" == typeof k) {
      "object" != typeof v.style && (v.style = {});
      for (var B = 0, w = k.split(";"); B < w.length; B++) {
        var C = w[B].split(":");
        if (!C.length) return;
        g = C[0], b = C[1];
...
var BuilderContent2 = function(_super) {
  ...
  return __extends(BuilderContent, _super), Object.defineProperty(BuilderContent.prototype, "builder", { get: function() {
    ...
    if (!this.props.inline || Builder.isEditing || Builder.isPreviewing) this.subscribeToContent();
      ...
      (null == n ? void 0 : n.id) && (this.builder.contentId = n.id, this.builder.trackImpression(n.id, this.renderedVariantId, void 0, { content: n }));
    }
...
var onChange_1 = createCommonjsModule(function(e, t) {
  ...
  var n = Symbol("target"), i = Symbol("unsubscribe"), r = function(e2, t2) {
    ...
    var s, l, u = Symbol("ProxyTarget"), d = false, c = false, p = false, f = a2.equals || Object.is, m = /* @__PURE__ */ new WeakMap(), h = /* @__PURE__ */ new WeakMap(), v = /* @__PURE__ */ new WeakMap(), g = function(e3, n2, i2, a3) {
      ...
      h.set(e3, t3);
      var n2 = v.get(e3);
      return void 0 === n2 && (n2 = new Proxy(e3, x), v.set(e3, n2)), n2;
    }, _ = function(e3) {
...
var tryEval = function(e, t, n) {
  ...
  if ("string" == typeof i && i.trim()) {
    ...
    try {
      ...
      var a = safeDynamicRequire("isolated-vm"), s = getIsolateContext();
      Object.keys(t).forEach(function(e2) {
        switch (e2) {
          case "state":
          case "global":
          case "log":
            console.warn("Not setting state.".concat(e2, " as global ").concat(e2, " in isolated vm"));
            break;
          default:
            if (void 0 === t[e2]) return;
            try {
              "object" == typeof t[e2] && null !== t[e2] ? s.global.setSync(e2, new a.ExternalCopy(t[e2]).copyInto()) : s.global.setSync(e2, t[e2]);
            } catch (t2) {
              console.warn("Could not set ".concat(e2, " for isolated-vm:"), t2);
            }
        }
      });
      var l = makeFn(e, r, ["state"]), u = s.evalClosureSync(l, [new a.Reference(t || {})]);
      try {
        return JSON.parse(u);
      } catch (e2) {
        return u;
        ...
        return n = t2.url, i = t2.method, r = t2.body, o = t2.headers, a = JSON.stringify({ url: n, method: i, body: r, headers: o }), Builder.isIframe && fetchCache[a] ? (this.updateState(function(t3) {
          ...
          return __awaiter(c, void 0, void 0, function() {
            ...
            return __generator(this, function(c2) {
              switch (c2.label) {
                case 0:
                  t3 = Date.now(), Builder.isBrowser || console.time("Fetch " + a), c2.label = 1;
                case 1:
                  return c2.trys.push([1, 4, 5, 6]), l2 = { method: i, headers: o, body: r }, "GET" === i && delete l2.body, [4, fetch$1(n, l2)];
                case 2:
                  return [4, c2.sent().json()];
                case 3:
                  return s2 = c2.sent(), [3, 6];
                case 4:
                  return u2 = c2.sent(), d2 = toError2(u2), this._errors && this._errors.push(d2), this._logs && this._logs.push("Fetch to ".concat(a, " errored in ").concat(Date.now() - t3, "ms")), [2];
                case 5:
...
var isNewReact = "use" in import_react3.default;
...
var ImageComponent = function(e) {
  ...
  return __extends(t, e), Object.defineProperty(t.prototype, "useLazyLoading", { get: function() {
  ...
  }, enumerable: false, configurable: true }), Object.defineProperty(t.prototype, "loadEagerly", { get: function() {
    var e2;
    return (null === (e2 = this.props.builderBlock) || void 0 === e2 ? void 0 : e2.id.startsWith("builder-pixel-")) || this.props.highPriority;
  }, enumerable: false, configurable: true }), Object.defineProperty(t.prototype, "fetchPriorityProp", { get: function() {
    var e2;
    return (e2 = {})[isNewReact ? "fetchPriority" : "fetchpriority"] = this.loadEagerly ? "high" : "auto", e2;
    ...
    return jsx(BuilderMetaContext.Consumer, null, function(e3) {
      ...
      } }, u && u.match(/builder\.io/) && !n.props.noWebp && jsx("source", { srcSet: u.replace(/\?/g, "?format=webp&"), type: "image/webp" }), s2), !r || i2 || p && l && l.length ? null : jsx("div", { className: "builder-image-sizer", css: { width: "100%", paddingTop: 100 * r + "%", pointerEvents: "none", fontSize: 0 } }, " "), l && l.length ? p ? l.map(function(e4, t4) {
...
var SymbolComponent = function(e) {
  ...
  return __extends(t, e), Object.defineProperty(t.prototype, "placeholder", { get: function() {
    ...
    return jsx(BuilderStoreContext.Consumer, { key: (s || "no model") + ":" + (l || "no entry" + this.isEditingThisSymbol) }, function(e3) {
      var t3, a2, c2, f2, h2, g, b, y, _, x, S, k = "".concat(m, "_").concat((null === (t3 = null == e3 ? void 0 : e3.state) || void 0 === t3 ? void 0 : t3.locale) || "Default");
...
var ImgComponent = function(e) {
  ...
  return __extends(t, e), t.prototype.getSrcSet = function() {
    ...
    var e2 = this.props.attributes || {}, t2 = this.getSrcSet(), n = e2.style, i = __rest(e2, ["style"]), r = { objectFit: this.props.backgroundSize, objectPosition: this.props.backgroundPosition, aspectRatio: this.props.aspectRatio }, o = __assign2(__assign2({}, r), n);
    return import_react3.default.createElement("img", __assign2({ loading: "lazy" }, i, { src: this.props.image || e2.src, srcSet: t2, alt: this.props.altText, title: this.props.title, style: o, className: "builder-raw-img" }));
  }, t;
}(import_react3.default.Component);
var Img = withBuilder(ImgComponent, { name: "Raw:Img", hideFromInsertMenu: true, image: "https://firebasestorage.googleapis.com/v0/b/builder-3b0a2.appspot.com/o/images%2Fbaseline-insert_photo-24px.svg?alt=media&token=4e5d0ef4-f5e8-4e57-b3a9-38d63a9b9dc4", inputs: [{ name: "image", bubble: true, type: "file", allowedFileTypes: IMAGE_FILE_TYPES, required: true }, { name: "backgroundSize", type: "text", defaultValue: "cover", enum: [{ label: "contain", value: "contain", helperText: "The image should never get cropped" }, { label: "cover", value: "cover", helperText: "The image should fill it's box, cropping when needed" }] }, { name: "backgroundPosition", type: "text", defaultValue: "center", enum: ["center", "top", "left", "right", "bottom", "top left", "top right", "bottom left", "bottom right"] }, { name: "altText", type: "string", helperText: "Text to display when the user has images off" }, { name: "title", type: "string", helperText: "Text to display when hovering over the asset" }, { name: "aspectRatio", type: "number", helperText: "This is the ratio of height/width, e.g. set to 1.5 for a 300px wide and 200px tall photo. Set to 0 to not force the image to maintain it's aspect ratio", advanced: true, defaultValue: 0.7041 }], noWrap: true });
...
function PersonalizationContainer(e) {
  var t, n, i, r, o, a, s, l, u, d, c, p, f, m, h, v, g, b, y, _, x, S = Boolean(Builder.isBrowser && (null === (t = window.__hydrated) || void 0 === t ? void 0 : t[null === (n = e.builderBlock) || void 0 === n ? void 0 : n.id])), k = (0, import_react3.useRef)(null), B = (0, import_react3.useState)(S), w = B[0], C = B[1], E = (0, import_react3.useState)(false), R = E[0], T = E[1], I = (0, import_react3.useState)(0);
  I[0];
  ...
  if ((0, import_react3.useEffect)(function() {
    ...
    if (!Builder.isEditing && !Builder.isPreviewing) {
      var i2 = P[0];
      null === (e2 = k.current) || void 0 === e2 || e2.dispatchEvent(new CustomEvent("builder.variantLoaded", { detail: { variant: i2 || "default", content: O.content }, bubbles: true }));
      var r2 = new IntersectionObserver(function(e3) {
        e3.forEach(function(e4) {
          var t3;
          e4.isIntersecting && (null === (t3 = k.current) || void 0 === t3 || t3.dispatchEvent(new CustomEvent("builder.variantDisplayed", { detail: { variant: i2 || "default", content: O.content }, bubbles: true })));
        });
      });
      r2.observe(k.current), n2.push(function() {
