...
export default function Sidebar({ onNavigate }: SidebarProps) {
  ...
  return (
    <aside className="w-64 h-screen flex-shrink-0 border-r border-[#E0E0E0] bg-white fixed left-0 top-0">
      <div className="p-6">
      ...
      <nav className="px-2 mt-10 space-y-24">
        <div>
          ...
          <button
            ...
            className={cn(
              "w-full flex items-center gap-4 px-4 h-10 rounded-lg transition-colors",
              isActive("/lemma") ? "bg-[#F7F7F7]" : "hover:bg-[#F7F7F7]"
            )}
          >
        ...
        <div>
          ...
          <button
            type="button"
            className="w-full flex items-center gap-4 px-4 h-10 rounded-lg transition-colors hover:bg-[#F7F7F7]"
          >
          ...
          <button
            ...
            className="w-full flex items-center gap-4 px-4 h-10 rounded-lg transition-colors hover:bg-[#F7F7F7]"
          >
            <div className="w-6 h-6 bg-[#FBBC05] rounded" />
