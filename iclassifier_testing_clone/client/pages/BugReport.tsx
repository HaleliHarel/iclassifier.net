          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              {imagePreview ? (
                ...
                <label className="flex flex-col items-center justify-center w-full px-3 py-6 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full px-4 py-3 bg-[#F5C842] text-[#0B1F6B] rounded-lg font-semibold hover:bg-[#F1BD2E] active:bg-[#EAB927] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
