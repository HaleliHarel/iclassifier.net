      ...
      for (const project of projects) {
        try {
          const response = await fetch(
            `/api/iclassifier/${project.id}/full?_t=${Date.now()}`
          );
  ...
  return (
    <SidebarLayout>
      <div className="max-w-4xl mx-auto p-6">
        <h1 className="text-3xl font-bold mb-6">Debug: Project Status</h1>

        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4">Defined Projects</h2>
          <p className="text-gray-600 mb-4">Found {projects.length} projects</p>
